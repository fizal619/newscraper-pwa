...
function _asyncToGenerator(a){return function(){var b=a.apply(this,arguments);return new Promise(function(c,d){function f(g,h){try{var i=b[g](h),j=i.value}catch(k){return void d(k)}return i.done?void c(j):Promise.resolve(j).then(function(k){f('next',k)},function(k){f('throw',k)})}return f('next')})}}var _marked=[helloSaga,loadNews,watchLoadNews,rootSaga].map(regeneratorRuntime.mark);var articles=[];function helloSaga(){return regeneratorRuntime.wrap(function(b){for(;;)switch(b.prev=b.next){case 0:console.log('Hello Sagas!');case 1:case'end':return b.stop();}},_marked[0],this)}var fetchNews=function(){var a=_asyncToGenerator(regeneratorRuntime.mark(function b(c){var d;return regeneratorRuntime.wrap(function(g){for(;;)switch(g.prev=g.next){case 0:return console.log('in fetch'),d=void 0,g.next=4,fetch('https://newscraper-pwa.herokuapp.com/news?s='+c).then(function(h){return h.json()}).then(function(h){return d=h});case 4:return console.log(d),g.abrupt('return',d);case 6:case'end':return g.stop();}},b,this)}));return function(){return a.apply(this,arguments)}}();function loadNews(){return regeneratorRuntime.wrap(function(b){for(;;)switch(b.prev=b.next){case 0:return console.log('got it'),b.next=3,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["put"])({type:'LOADING'});case 3:return b.prev=3,console.log('this far'),articles=[],b.t0=articles,b.next=9,fetchNews('hacker-news');case 9:return b.t1=b.sent,articles=b.t0.concat.call(b.t0,b.t1),b.t2=articles,b.next=14,fetchNews('ars-technica');case 14:return b.t3=b.sent,articles=b.t2.concat.call(b.t2,b.t3),b.t4=articles,b.next=19,fetchNews('techcrunch');case 19:return b.t5=b.sent,articles=b.t4.concat.call(b.t4,b.t5),b.t6=articles,b.next=24,fetchNews('engadget');case 24:return b.t7=b.sent,articles=b.t6.concat.call(b.t6,b.t7),console.log('this far 2'),console.log(articles),b.next=30,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["put"])({type:'LOADED',articles:articles});case 30:return b.next=32,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["put"])({type:'NOT_LOADING'});case 32:b.next=39;break;case 34:return b.prev=34,b.t8=b['catch'](3),console.log(b.t8),b.next=39,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["put"])({type:'NOT_LOADING'});case 39:case'end':return b.stop();}},_marked[1],this,[[3,34]])}function watchLoadNews(){return regeneratorRuntime.wrap(function(b){for(;;)switch(b.prev=b.next){case 0:return b.next=2,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["takeEvery"])('LOAD',loadNews);case 2:case'end':return b.stop();}},_marked[2],this)}function rootSaga(){return regeneratorRuntime.wrap(function(b){for(;;)switch(b.prev=b.next){case 0:return b.next=2,[helloSaga(),watchLoadNews()];case 2:case'end':return b.stop();}},_marked[3],this)}
...
"use strict";
var initialState={articles:[{title:'Hit Refresh for the latest headlines from TechCrunch',content:'Woah! Go back and hit refresh you doof.'}]};/* harmony default export */ __webpack_exports__["a"] = function(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:initialState,b=arguments[1];switch(b.type){case'LOADED':return console.log('LOADED NEWS'),Object.assign({},a,{articles:b.articles});case'CLEAR':return{articles:[]};default:return console.log('DEFAULT NEWS'),a;}};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_errors_404__ = __webpack_require__("./src/views/pages/errors/404.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_credit__ = __webpack_require__("./src/views/pages/credit.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_blog__ = __webpack_require__("./src/views/pages/blog.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_react_redux__ = __webpack_require__("./node_modules/react-redux/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_redux__ = __webpack_require__("./node_modules/redux/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_redux_saga__ = __webpack_require__("./node_modules/redux-saga/lib/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_redux_saga___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_redux_saga__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_redux_persist__ = __webpack_require__("./node_modules/redux-persist/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__reducers_index__ = __webpack_require__("./src/reducers/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__actions_sagas__ = __webpack_require__("./src/actions/sagas.js");
var sagaMiddleware=__WEBPACK_IMPORTED_MODULE_10_redux_saga___default()(),store=__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_redux__["a" /* createStore */])(__WEBPACK_IMPORTED_MODULE_12__reducers_index__["a" /* default */],__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_redux__["b" /* compose */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_redux__["c" /* applyMiddleware */])(sagaMiddleware),__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_11_redux_persist__["a" /* autoRehydrate */])()));sagaMiddleware.run(__WEBPACK_IMPORTED_MODULE_13__actions_sagas__["a" /* default */]),__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_11_redux_persist__["b" /* persistStore */])(store,{whitelist:['news']});var onChange=function(a){return window.ga&&ga('send','pageview',a.url)};/* harmony default export */ __webpack_exports__["default"] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_8_react_redux__["a" /* Provider */],{store:store},__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_3__tags_layout__["a" /* default */],null,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_1_preact_router__["Router"],{onChange:onChange},__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_2__pages_home__["a" /* default */],{path:'/'}),__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_4__pages_article__["a" /* default */],{path:'/article/:id'}),__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_5__pages_errors_404__["a" /* default */],{'default':!0}))));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_preact_router__ = __webpack_require__("./node_modules/preact-router/dist/preact-router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_preact_router___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_preact_router__);
/* harmony default export */ __webpack_exports__["a"] = function(a){return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('div',{className:'btn'},__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('a',{onClick:a.callback},a.name))};

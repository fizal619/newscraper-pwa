...
var _marked=[helloSaga,loadNews,watchLoadNews,rootSaga].map(regeneratorRuntime.mark);function helloSaga(){return regeneratorRuntime.wrap(function(b){for(;;)switch(b.prev=b.next){case 0:console.log('Hello Sagas!');case 1:case'end':return b.stop();}},_marked[0],this)}function loadNews(){return regeneratorRuntime.wrap(function(d){for(;;)switch(d.prev=d.next){case 0:return console.log('got it'),d.next=3,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["put"])({type:'LOADING'});case 3:return d.next=5,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["call"])(fetch,'/?s=techcrunch');case 5:return a=d.sent,d.next=8,a.json();case 8:return b=d.sent,console.log(b),d.next=12,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["put"])({type:'LOADED',articles:b});case 12:return d.next=14,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["put"])({type:'NOT_LOADING'});case 14:case'end':return d.stop();}},_marked[1],this)}function watchLoadNews(){return regeneratorRuntime.wrap(function(b){for(;;)switch(b.prev=b.next){case 0:return b.next=2,__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_saga_effects__["takeEvery"])('LOAD',loadNews);case 2:case'end':return b.stop();}},_marked[2],this)}function rootSaga(){return regeneratorRuntime.wrap(function(b){for(;;)switch(b.prev=b.next){case 0:return b.next=2,[helloSaga(),watchLoadNews()];case 2:case'end':return b.stop();}},_marked[3],this)}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_sass__ = __webpack_require__("./src/index.sass");
